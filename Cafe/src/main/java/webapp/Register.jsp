...
<form name="Login-form" action="userRegister" method="post">
<label for="mail">Name: </label><input id="username" type="text" name="username" placeholder="Please Enter your Name" required></input><br>
...
<label  for="password">Confirm Password: </label><input id="cpwd" name="confirmpassword" type="password" placeholder="Please Re-Enter your Password" required></input><br>
